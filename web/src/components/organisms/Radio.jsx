...
function Radio({ id, label, checked, className, onChange, ...rest }) {
  return (
    <div
    ...
    >
      <input
        ...
        value=''
        name={id}
        checked={checked}  // Ensure only one radio button is checked at a time
        onChange={onChange}  // Add the onChange event handler to handle radio button selection
